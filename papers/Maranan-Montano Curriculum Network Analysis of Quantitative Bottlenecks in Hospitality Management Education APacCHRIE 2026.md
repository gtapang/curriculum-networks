...
centrality = 0.0335). Louvain community detection confirms strong
...
by 2025. However, this growth has collided with the structural
rigidities of the 156-unit curriculum revised in 2021. Preliminary data
from the inaugural 2021 cohort reveal a concerning trend: only 24%
graduated on time. On-time graduation means completing all 156 required
units within eight regular semesters (four academic years), excluding
midyear terms. The remaining 76% have either withdrawn or faced
significant delays.
...
series requires successful completion of HRIM 131 (Operations
Management), a critical fifth-semester block that must be taken in its
entirety. HRIM 131 requires Math 21 (Elementary Analytics) and Stat 101
(Elementary Statistics). High failure rates in these foundational
subjects have created a massive backlog. The department has offered HRIM
131 every semester since 2022 to accommodate students delayed from one
to five semesters.
...
Philippine hospitality programs face additional complexity. The BS HRIM
...
starting with Math 20, a non-credit bridging course that is a
prerequisite for Math 21. Stat 101 and Math 21 are prerequisites for
HRIM 131, which is the gateway to the HRIM 150 series. Failure at any
node in this sequence blocks all downstream progression. Academic
advisers encourage students to attempt Math 21 and Stat 101 during their
first year to minimize cumulative delay.

![](media/image2.png){width="6.267716535433071in"
height="3.7222222222222223in"}

*Figure 1. Structural Curriculum Network of the BS HRIM Program (156
Units). Nodes represent individual courses; directed edges point from
...
blue = HRIM foundation cluster, grey = GE and other clusters). Node size
is proportional to out-degree. Key bottleneck courses (Math 21, Stat
101, HRIM 120, HRIM 131) are labeled in the figure.*
...
cohesive unit. C2 (9 courses) captures the HRIM foundation cluster
anchored by HRIM 120, encompassing all seven courses directly unlocked
by HRIM 120, along with its two prerequisite feeders (HRIM 110, HRIM
116). Smaller communities correspond to the PE series, English
composition, NSTP, and foreign language elective pairs. The high
modularity reinforces structural asymmetry: the curriculum is a set of
largely separate prerequisite sub-chains converging at two chokepoints,
HRIM 120 and HRIM 131, before diverging again into the senior tier.
...
***Table 1. Structural Centrality Measures --- Key BS HRIM Curriculum
Nodes***
...
101, and HRIM 120---converge and fan out into the HRIM 150 series,
making it the curriculum's structural chokepoint. Second, HRIM 120 has
the highest out-degree and blocking factor (8), serving as the program's
primary hub; a single failure can lock out eight courses simultaneously.
Third, Math 21's betweenness is comparatively lower (BC = 0.0059), but
its reach of 17 and delay factor of 4 confirm disproportionate
downstream influence. Any student who fails Math 21 is indirectly
blocked from 17 courses and faces a prerequisite chain four levels deep
...
students have passed Stat 101 than Math 21. Low completion rates for
...
*Figure 2. Empirical Progression Network of BS HRIM Students (N = 269,
...
Self-loops on Math 21, Stat 101, and PE 2 indicate re-enrolment.*

![](media/image1.png){width="6.267716535433071in"
height="3.4166666666666665in"}

*Figure 3. BS HRIM Student Progression Flow (N = 269). Three-tier
curriculum funnel from enrollment through the quantitative gate to
upper-division HRIM coursework and near-completion. Grey = not yet at
quantitative gate (n ≈ 75); Red = retaking Math 21 or Stat 101 (n ≈ 23);
Orange = pending next milestone; Green/Teal = milestone cleared.*
...
through the quantitative gate (Math 21 + Stat 101), to HRIM 131, then to
the HRIM 150+ series and near completion. It highlights three key flows:
students not yet at the quantitative gate; students stuck in
quantitative retakes (Math 21/Stat 101); and students who have cleared
HRIM 131 and are either pending HRIM 150+ or already near/at completion.
The width of each stream makes clear that the largest losses and delays
occur at the quantitative gate and just before HRIM 150+, not in the
upper-division HRIM core itself.
...
***Table 9. Self-Loop Analysis***
  ...
  **Course**        **Retake Count**  **Avg Grade at    **Interpretation**
                                      Entry**           
  ----------------- ----------------- ----------------- --------------------
  PE 2              182               1.27              Structural: required
                                                        to take PE four
                                                        times
  ...
  Math 21           71                4.94              Failure-driven: avg
                                                        grade ≈ 5.0,
                                                        mandatory retake
  ...
  Stat 101          21                4.85              Failure-driven: avg
                                                        grade ≈ 5.0,
                                                        required retake
...
prerequisite restrictions---specifically, failure to pass Math 21 on
time. PI 100 (Life and Works of Jose Rizal), mandated by Republic Act
No. 1425, has been completed by 59 students with a 0.0% failure rate.
...
faces two consequences: delay in that single course and effective
...
who failed Math 21 to take HRIM 131 concurrently, with both courses
required before progressing to the HRIM 150 series. Without this change,
the Math 21 self-loop continues indefinitely. All HRIM courses above
HRIM 120 have zero failures, suggesting that once students clear the
quantitative prerequisites, they are well prepared to complete their
major requirements.
...
students who have attempted Math 21, only 171 have passed, leaving 23
students (11.9%) caught in mandatory retake cycles. The self-loop weight
of 71 means Math 21 has consumed approximately 71 additional
...
from CalTech's 771-node network to UIUC's 5,126-node network. The BS
HRIM finding extends this structural regularity to a non-STEM,
service-sector professional program in the ASEAN region. In Zuev &
Stavrinides's (2025) flux framework, the stratum containing Math 21
would exhibit anomalously high positive flux---it emits far more
...
students who have not cleared Math 21 or Stat 101 by end of their second
